   ...
   <>
    <div className="w-[100%] sticky px-12  top-0 py-5 font-textFont bg-white drop-shadow-xl z-50">
      <div className='flex justify-between items-center w-auto'>
        ...
        {/* navbar section  */}
        <div>
            <h2 className='text-black text-3xl md:block hidden'>Library Management System</h2>
        </div>
        
       {/* login and signup button section  */}
       <div className='block md:pl-10 pl-10'>
       <Link to='/login'>  <button className='bg-btnColor px-6 py-2 text-black font-textFont rounded-full border-none ' >
        A</button> </Link>
